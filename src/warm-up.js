...
if(pages < 25) {isShortStory=true} else {isShortStory = false};
...
if(pages < 1000) {console.log('I could read that in a day!')} else {console.log('Ok, maybe I could read that in a day and a half.')}
...
if (isFavorite === true) {console.log(`My favorite book is ${title}!`)} else {console.log(`I recently read the ${title} book.`)}
...
var books = ['The Toyota Way', 'The Anarchists Tool Chest', 'Learn Python 3 The Hard Way', 'The Pocket Tao', 'Anna Karenina'];

// Write the code to access the 3rd element of the Array, using bracket
// notation.

var specificBook = books[2];

// Create a new variable "belowTwoHundred" and assign it to an Array of 12
// different numbers below two hundred.

var belowTwoHundred = [8, 87, 64, 35, 116, 24, 95, 72, 44, 186, 12, 19];

// Write the code to access the 5th element of the array, using bracket notation.

var specificNumber = belowTwoHundred[4];
